...
function es6ObjectComputedProperties(traverse, node, path, state) {
    ...
    for (var ii = 0; ii < node.properties.length; ++ii) {
        ...
        if (property.type === Syntax.SpreadProperty) {
            ...
            while (
            nextComputedPropertyIndex < node.properties.length && !node.properties[nextComputedPropertyIndex].computed
                ) {
            ...
            property.key.type === Syntax.Identifier && !property.computed
        ) {
